        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <button style="float: right;" action="<?php echo base_url(); ?>pegawai/form" type="button" class="add btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</button>
                        <br />
                        <br />
...
$data['modal_id'] = 'form-pegawai';
$data['modal_size'] = 'sm';
$data['modal_title'] = 'Form Pegawai';
...
<script>
    let _table = $('#pegawai');
    let _url = "<?php echo base_url(); ?>pegawai/ajax";
    let _modal = $('#form-pegawai');
