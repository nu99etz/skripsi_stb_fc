...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Data Penyebab Keruskan
            <small>Data Penyebab Kerusakan</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Master Kerusakan STB</li>
            <li class="active">Data Penyebab Kerusakan</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Data Penyebab Kerusakan</h3>
                    </div>
                    <div class="box-body">
                        <button style="float: right;" action="<?php echo base_url(); ?>penyebab_kerusakan/form" type="button" class="add btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</button>
                        <br />
                        <br />
                        <table id="penyebab_kerusakan_table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
...
$data['modal_id'] = 'form-penyebab-kerusakan';
$data['modal_size'] = 'lg';
$data['modal_title'] = 'Form Penyebab Kerusakan';
$this->load->view('_partial/modal', $data);

?>

<script>
    let _table = $('#penyebab_kerusakan_table');
    let _url = "<?php echo base_url(); ?>penyebab_kerusakan/ajax";
    let _modal = $('#form-penyebab-kerusakan');
